...
export class GrillaCurso {
 ...
 micolor;
    ...
    texto;
  constructor(private file: File, private alertCtrl: AlertController, public navCtrl: NavController, public auth: servicioAuth ,public navParams: NavParams, public viewCtrl: ViewController,
...
leerArchivo(nombreArch){
    this.archivo.readAsText(this.archivo.externalDataDirectory,"lista2.txt").then(fileStr => {
        this.texto = fileStr;
        console.info("text: "+this.texto);
    }).catch(err => console.log('errleerarchivo'));
